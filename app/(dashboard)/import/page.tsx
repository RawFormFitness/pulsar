...
//
// "Your Data" import-status home view. Server component.
//
// This used to live at the dashboard root (/dashboard). Phase 3A moved
// the analytics report to the root and pushed this status surface to
// /dashboard/import. The page itself is unchanged: it renders facts
// about what's been imported (last import date, per-source row counts,
// empty state) and hosts the import wizard.
//
...
export default async function DashboardImportHome() {
